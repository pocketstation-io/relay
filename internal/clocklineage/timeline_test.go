...
func TestGivenUnknownLineage_WhenCaptureTimeRequested_ThenMappingIsRejected(t *testing.T) {
...
func TestGivenPublisherSenderReport_WhenRTPAdvances_ThenCaptureTimeFollowsNTP(t *testing.T) {
...
func TestGivenRTPWraparound_WhenCaptureTimeRequested_ThenSerialDeltaIsPreserved(t *testing.T) {
	base := time.Date(2026, 7, 12, 10, 0, 0, 0, time.UTC)
...
func TestGivenStaleSenderReport_WhenCaptureTimeRequested_ThenMappingIsRejected(t *testing.T) {
	base := time.Date(2026, 7, 12, 10, 0, 0, 0, time.UTC)
...
func TestGivenSourceReconnect_WhenNewTimelineHasNoReport_ThenOldMappingIsNotReused(t *testing.T) {
	base := time.Date(2026, 7, 12, 10, 0, 0, 0, time.UTC)
...
func TestGivenCaptureMappingAcrossWrap_WhenSubscriberSenderReportGenerated_ThenNTPIsNormalized(t *testing.T) {
	base := time.Date(2026, 7, 12, 10, 0, 0, 0, time.UTC)
...
func TestGivenNoCaptureMapping_WhenSubscriberSenderReportGenerated_ThenPionNTPIsPreserved(t *testing.T) {
	base := time.Date(2026, 7, 12, 10, 0, 0, 0, time.UTC)
	timeline := NewTimeline(77)
	wantNTP := toNTP(base)
