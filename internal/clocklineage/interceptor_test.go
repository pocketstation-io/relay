...
func TestGivenIncomingSenderReport_WhenRTCPRead_ThenRemoteTimelineIsUpdated(t *testing.T) {
...
func TestGivenOutgoingSenderReport_WhenRTCPWritten_ThenLocalTimelineIsUpdated(t *testing.T) {
	registry := NewRegistry()
	factory := &InterceptorFactory{Registry: registry}
	interceptorInstance, err := factory.NewInterceptor("test")
	if err != nil {
...
func TestGivenOutgoingSenderReportAndCaptureMapping_WhenRTCPWritten_ThenClockIsNormalized(t *testing.T) {
