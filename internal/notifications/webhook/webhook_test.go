...
func TestGivenWebhookURLWhenEventIsDispatchedThenRequestIsSent(t *testing.T) {
	t.Parallel()
...
func TestGivenNilWebhookURLWhenEventIsDispatchedThenNoRequestIsSent(t *testing.T) {
	t.Parallel()
...
func TestGivenSessionStartedEventWhenEncodedThenRequiredFieldsArePresent(t *testing.T) {
	t.Parallel()
...
func TestGivenWebhookDeliverySlotsOccupiedWhenMoreEventsArriveThenOverflowIsDropped(t *testing.T) {
	...
	dispatcher := webhook.New(server.URL)
	...
	if got := dispatcher.DroppedTotal(); got != 1 {
