...
func TestGivenCachedPacket_WhenLoadedBySequence_ThenPacketIsReturned(t *testing.T) {
...
func TestGivenOverwrittenCacheSlot_WhenOldSequenceLoaded_ThenMissIsReturned(t *testing.T) {
	var cache retransmissionCache
...
func TestGivenRepeatedNACKWithinThrottle_WhenLoaded_ThenSecondRequestIsThrottled(t *testing.T) {
	var cache retransmissionCache
...
func TestGivenMeasuredRTT_WhenRepeatedNACKArrives_ThenTwoRTTsAreRespected(t *testing.T) {
	var cache retransmissionCache
...
func TestGivenThreeRetransmissions_WhenNACKRepeats_ThenFurtherRequestsAreThrottled(t *testing.T) {
	var cache retransmissionCache
